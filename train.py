...
class DeepLab_v3():
    def __init__(self, num_classes, multi_grid, atrous_rates, output_stride, scales, ignore_index=-1, gpu_id=0, print_freq=10, epoch_print=10):
        ...
        self.model = model.ResNet_ASPP(self.num_classes, self.multi_grid, self.atrous_rates, self.output_stride, self.scales).cuda(self.gpu)
    ...
    def train(self, train_data, test_data, save=False, epochs=74, lr=0.01, momentum=0.9, weight_decay=0.0005):
        ...
        lmbda = lambda epoch: (1 - epoch/(2*epochs)) ** 0.9
